...
public class Event {
    ...
    public static Event createFromRawLine(String line, List<AssStyle> ls, List<AssActor> la, List<AssEffect> lf) {
    ...
    public static Event createFromRawLine(String line, ASS ass) {
