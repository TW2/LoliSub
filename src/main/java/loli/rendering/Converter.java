...
public class Converter {
    ...
    public static Converter creteShapes(Event event, ASS ass){
    ...
    private List<Char> getChars(Graphics2D g, Event event, ASS ass){
    ...
    private Drawing getDrawing(Event event, ASS ass){
    ...
    private List<Char> doDiv(Event event){
     ...
     */
    private List<Char> doFontForEach(Graphics2D g, List<Char> chars, Event event, ASS ass){
     ...
     */
    private Font getFont(Graphics2D g, Event event, ASS ass){
        // =========
        // Size in pixel
        // =========
     ...
     * @return a Font to apply
     */
    private Font getFont(Graphics2D g, Event event, ASS ass, Char c){
        // =========
