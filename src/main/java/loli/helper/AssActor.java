...
import loli.enumeration.AssActorType;
...
public class AssActor {
    ...
    public AssActor(String name, HColor color, String b64Image, AssActorType kind) {
        this.name = name;
        this.color = color;
    ...
    public AssActor(String name) {
        this(name, new HColor(Color.black), null, AssActorType.Unknown);
    }

    public AssActor() {
        this("Unknown", new HColor(Color.black), null, AssActorType.Unknown);
    }
    ...
    public static AssActor fromLine(String line){
        ...
        actor.color = new HColor(new Color(Integer.parseInt(t[1])));
