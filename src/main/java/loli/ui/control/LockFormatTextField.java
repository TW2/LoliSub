...
import static loli.ui.control.LockFormatTextField.Format.AssTime;
...
public class LockFormatTextField extends JPanel {
    ...
    public LockFormatTextField() {
        ...
        formatAssTime = OnLoad.images("thin-present-blue.png");
        formatMsTime = OnLoad.images("thin-present-yellow.png");
        formatFrame = OnLoad.images("thin-present-red.png");
        lockNOT = OnLoad.images("thin-linkNOT.png");
        lockOK = OnLoad.images("thin-linkOK.png");
                ...
                switch(format){
                    case AssTime -> {
                        if(placeholderTextField1.getText().matches("\\d{1}:\\d{2}:\\d{2}.{1}\\d{2}")){
                            assTime = loli.helper.AssTime.create(placeholderTextField1.getText());
                        }
                    }
                    case MsTime -> {
