...
import loli.ui.dialog.VersionsDialog;
...
public class FlagVersion extends JPanel {
    ...
    public FlagVersion(ISO_3166 iso, JTextPane pSrc, JTextPane pDst){
        ...
        linkOK = OnLoad.images("thin-linkOK.png");
        linkNOT = OnLoad.images("thin-linkNOT.png");

        btnVersionsEdit = new JButton(OnLoad.images("16 engrenage mauve.png"));
