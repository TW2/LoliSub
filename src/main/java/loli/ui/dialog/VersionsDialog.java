...
public class VersionsDialog extends JDialog {
    ...
    public VersionsDialog(Frame parent, boolean modal, ISO_3166 iso){
        ...
        setTitle(Sub.L.getString("titleVersionDetailsDialog"));

        JButton btnOK = new JButton(Sub.L.getString("msgOK"));
        JButton btnCancel = new JButton(Sub.L.getString("msgCancel"));
        btnAddVersion = new JButton(Sub.L.getString("btnDialogAddVersion"));
        btnRemoveVersion = new JButton(Sub.L.getString("btnDialogRemoveVersion"));
