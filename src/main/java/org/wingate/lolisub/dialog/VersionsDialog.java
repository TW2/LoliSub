...
public class VersionsDialog extends JDialog {
    ...
    public VersionsDialog(Frame parent, boolean modal, ISO_3166 iso){
        ...
        setTitle(LoliSub.RSX.getString("titleVersionDetailsDialog"));

        JButton btnOK = new JButton(LoliSub.RSX.getString("msgOK"));
        JButton btnCancel = new JButton(LoliSub.RSX.getString("msgCancel"));
        btnAddVersion = new JButton(LoliSub.RSX.getString("btnDialogAddVersion"));
        btnRemoveVersion = new JButton(LoliSub.RSX.getString("btnDialogRemoveVersion"));
    ...
    public static class Renderer extends JPanel implements ListCellRenderer<ISO_3166> {
        ...
        public Component getListCellRendererComponent(JList<? extends ISO_3166> list,
            ...
            lblFlag.setIcon(Ico.locations(value.getAlpha2() + ".gif"));
