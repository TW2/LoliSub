package org.wingate.lolisub;

import com.formdev.flatlaf.FlatDarkLaf;
import com.formdev.flatlaf.FlatLightLaf;
import org.bytedeco.javacv.FrameGrabber;
import org.wingate.lolisub.ass.ASS;
import org.wingate.lolisub.dialog.AboutDialog;
...
import org.wingate.lolisub.ui.audiovideo.WaveFormPanel;
import org.wingate.lolisub.helper.DrawColor;
import org.wingate.lolisub.helper.Ico;
import org.wingate.lolisub.helper.Msg;
import org.wingate.lolisub.ui.audiovideo.AudioPanel;
import org.wingate.lolisub.ui.audiovideo.VideoPanel;
import org.wingate.lolisub.ui.audiovideo.VideoPlayer;
import org.wingate.lolisub.ui.table.ChatPanel;
import org.wingate.lolisub.ui.table.MainRenderer;
...
public class MainFrame extends JFrame {
    ...
    private JMenuBar createMainMenu(){
        ...
        mnuLightMode.setIcon(Ico.images("16 carbon--light-color.png"));
        mnuLightMode.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                try{
                    ...
                    Msg.dialogErr(exc.getLocalizedMessage());
                }
        ...
        mnuDarkMode.setIcon(Ico.images("16 carbon--moon-color.png"));
        ...
        mnuSettings.setIcon(Ico.images("16 carbon--settings-green.png"));
        ...
        mnuAutomation.setIcon(Ico.images("16 carbon--chemistry.png"));
        JMenu mnuPlugins = new JMenu("Plugins");
        mnuPlugins.setIcon(Ico.images("16 carbon--settings-green.png"));

        menuBar.add(mnuAutomation);
        mnuAutomation.add(mnuPlugins);

        final JMenu mnuAbout = new JMenu("");
        mnuAbout.setIcon(Ico.images("16 carbon--cafe.png"));
    ...
    private JMenuBar createTopLayersMenu() {
        ...
        final JMenu mnuFile = new JMenu(LoliSub.RSX.getString("mnuFile"));
        menuBar.add(mnuFile);

        final JMenuItem mFileOpenV = new JMenuItem(LoliSub.RSX.getString("mFileOpenVideo"));
        mFileOpenV.setIcon(Ico.images("20-folder.png"));
        ...
        mFileOpenV.addActionListener((e)->{
            ...
            fcFile.setFileFilter(new FileFilter() {
                ...
                public String getDescription() {
                    return LoliSub.RSX.getString("VideoFiles");
                }
            });
        ...
        final JMenuItem mFileOpenA = new JMenuItem(LoliSub.RSX.getString("mFileOpenAudio"));
        mFileOpenA.setIcon(Ico.images("16 note2.png"));
        ...
        mFileOpenA.addActionListener((e)->{
            ...
            fcFile.setFileFilter(new FileFilter() {
                ...
                @Override
                public String getDescription() {
                    return LoliSub.RSX.getString("AudioFiles");
                }
            });
            int z = fcFile.showOpenDialog(this);
            if(z == JFileChooser.APPROVE_OPTION){
    ...
    private JMenuBar createBottomLayersMenu() {
        ...
        final JMenu mnuFile = new JMenu(LoliSub.RSX.getString("mnuFile"));
        menuBar.add(mnuFile);
        final JMenu mnuEdit = new JMenu(LoliSub.RSX.getString("mnuEdit"));
        menuBar.add(mnuEdit);

        final JMenuItem mFileOpenASS = new JMenuItem(LoliSub.RSX.getString("mFileOpenASS"));
        mFileOpenASS.setIcon(Ico.images("20-folder.png"));
        ...
        mFileOpenASS.addActionListener((e)->{
            ...
            fcFile.setFileFilter(new FileFilter() {
                ...
                @Override
                public String getDescription() {
                    return LoliSub.RSX.getString("fFilter");
                }
            });
            int z = fcFile.showOpenDialog(this);
            if(z == JFileChooser.APPROVE_OPTION){
        ...
        final JMenuItem mFileSaveASS = new JMenuItem(LoliSub.RSX.getString("mFileSaveASS"));
        mFileSaveASS.setIcon(Ico.images("20-floppydisk.png"));
        ...
        JRadioButtonMenuItem mEditNoStrip = new JRadioButtonMenuItem(LoliSub.RSX.getString("mEditNoStrip"));
        ...
        JRadioButtonMenuItem mEditSignStrip = new JRadioButtonMenuItem(LoliSub.RSX.getString("mEditSignStrip"));
        ...
        JRadioButtonMenuItem mEditStripAll = new JRadioButtonMenuItem(LoliSub.RSX.getString("mEditStripAll"));
    ...
    private JMenuBar createTopSwitchMenu() {
        ...
        final JMenu mnuSwitch = new JMenu(LoliSub.RSX.getString("mnuCycle"));
