...
import org.wingate.lolisub.dialog.VersionsDialog;
...
public class FlagVersion extends JPanel {
    ...
    public FlagVersion(ISO_3166 iso, JTextPane pSrc, JTextPane pDst){
        ...
        linkOK = Ico.images("thin-linkOK.png");
        linkNOT = Ico.images("thin-linkNOT.png");

        btnVersionsEdit = new JButton(Ico.images("16 engrenage mauve.png"));
    ...
    public static class ComboBoxVersionRenderer extends JPanel implements ListCellRenderer<ISO_3166> {
        ...
        public ComboBoxVersionRenderer(){
            lblFlag = new JLabel(Ico.locations(ISO_3166.getISO_3166(Locale.getDefault().getISO3Country()).getAlpha2().toLowerCase() + ".gif"));
        ...
        public Component getListCellRendererComponent(
            ...
            try{
                lblFlag.setIcon(Ico.locations(value.getAlpha2().toLowerCase() + ".gif"));
            }catch(Exception _){
