    ...
    public AudioPanel(MainFrame mainFrame, VideoPlayer videoPlayer){
        ...
        scrollH.addAdjustmentListener((e) -> {
            try {
                ...
                Msg.consoleErr(ex.getLocalizedMessage());
            }
        });

        JButton btnPlay = new JButton(Ico.images("16_timer_stuffs play.png"));
        JButton btnPause = new JButton(Ico.images("16_timer_stuffs pause.png"));
        JButton btnStop = new JButton(Ico.images("16_timer_stuffs stop.png"));
        ...
        JButton btnPlayBefore = new JButton(Ico.images("16_timer_stuffs play out 01.png"));
        JButton btnPlayBegin = new JButton(Ico.images("16_timer_stuffs play in 01.png"));
        JButton btnPlayArea = new JButton(Ico.images("16_timer_stuffs in.png"));
        JButton btnPlayEnd = new JButton(Ico.images("16_timer_stuffs play in 02.png"));
        JButton btnPlayAfter = new JButton(Ico.images("16_timer_stuffs play out 02.png"));
